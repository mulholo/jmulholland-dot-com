...
easy input methods facilitate effortless creation, just as a good
...
<FootnoteParagraphWrapper>
  <p>
    ...
    as-need basis, keeping the process lean.<FootnoteN>1</FootnoteN>
    Working this way is less stressful too, and it helps me counter my
    sometimes perfectionist tendencies.
  </p>
  <FootnoteStack>
    <Footnote n={1}>
      See{' '}
      <a href='https://praxis.fortelabs.co/progressive-summarization-a-practical-technique-for-designing-discoverable-notes-3459b257d3eb/'>
        Tiago Forte’s Progressive Summarisation
      </a>{' '}
      for a note-taking method that works in this way.
    </Footnote>
  </FootnoteStack>
</FootnoteParagraphWrapper>
...
<FootnoteParagraphWrapper>
  <p>
    When writing and refactoring software<FootnoteN>2</FootnoteN>, an
    excellent approach is Kent Beck’s “Make it work, make it right,
    make it fast”. Analogously, for note-taking, first, you do{' '}
    <em>something</em> to get your ideas down. Then, you tidy them up.
    Finally, you put the information in the most usable format
    possible.
  </p>
  <FootnoteStack>
    <Footnote n={2}>
      Refactoring is the process of improving software without
      changing its underlying behaviour.
    </Footnote>
  </FootnoteStack>
</FootnoteParagraphWrapper>
