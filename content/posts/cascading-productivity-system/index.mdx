...
After finding so many similar posts useful, I wanted to document and
share my personal productivity system.
...
<FootnoteParagraphWrapper>
  <p>
    At 18:00 on a typical workday, I do what I call the Daily Meeze
    <FootnoteN>1</FootnoteN>
    which takes the form of a checklist in Notion that looks like
    this:
  </p>
  <FootnoteStack>
    <Footnote n={1}>
      The term ‘meeze’ comes from the book{' '}
      <a href='https://www.amazon.co.uk/dp/B01AXE98PU/ref=dp-kindle-redirect?_encoding=UTF8&btkr=1'>
        Work Clean
      </a>{' '}
      although I’ve expanded the term so that it encompasses weekly
