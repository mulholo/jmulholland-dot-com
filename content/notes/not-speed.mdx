...
- Speed is useless if you're going in the wrong direction. Aim for the
  ...
  direction.
- Tortoise and hare dynamics may come into play: sometimes slow and
  steady wins the race. A dragster may win on a quarter-mile, but if
  you're racing across tough terrain, a bicycle might be quicker.

## See Also

See also: <Link to="/speed">Speed matters _more_ than you think</Link>
